...
Note that create-react-app is not part of the React library. It is a tool used to setup React applications without having to configure every aspect of a modern application, like code transpiling, minification, modularization, unit testing, local environment servers, hot-reloading and many others.
...
- **package-lock.json** - This file gets generated automatically when you install dependencies for the first time, or when you update them. It keeps track of all depedencies your application requires, including their exact versions.
